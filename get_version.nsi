; Script, run at compile time by installer builder, to extract the latest version identifier from RedemptionPackageChanges.txt
...
OutFile "GetRedemptionPackageVersion.exe"
SilentInstall silent

Section

; Get file version
${LineRead} "MUSHclient\RedemptionPackageChanges.txt" "3" $R0
